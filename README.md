...
**[Open Signal Lens AI](https://signal-lens-ai.vercel.app)** — a public live demo hosted on Vercel.
...
The frontend is built with React, TypeScript, Vite, Tailwind CSS, and Lucide icons. Vercel serves the static production bundle generated by Vite.
